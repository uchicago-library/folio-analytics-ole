...
jsonb_extract_path_text(ii.jsonb,'statusUpdatedDate')::timestamp with time zone AS status_updated_date,
...
SELECT
    ...
    jsonb_extract_path_text(check_ins.jsonb,'occurredDateTime')::timestamp with time zone AS occurred_date_time,
...
SELECT
    ...
    NULL AS cntnt_desc,
    jsonb_extract_path_text(circ_req.jsonb,'requestExpirationDate')::timestamp with time zone AS rqst_expir_dt_time,
    NULL AS rcal_ntc_snt_dt,
    NULL AS onhld_ntc_snt_dt,
    jsonb_extract_path_text(circ_req.jsonb,'requestDate')::timestamp with time zone AS crte_dt_time,
    NULL AS modi_dt_time,
    NULL AS cpy_frmt,
    NULL AS loan_tran_id,
